...
You are then going to modify a function called days_in_month() 
which will take a year and a month as inputs, e.g.
days_in_month(year=2022, month=2)

And it will use this information to work out if the year is a leap year 
and decide the number of days in the month, then return that as the output, e.g.:
28
...
def days_in_month(year, month):
  """
  This function will take a year and a month as inputs,
  and it will use this information to work out if the year is a leap year
  """
...
month = int(input("Mounth: ")) # Enter a month
